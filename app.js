...
const searchByName = () => {
  ...
  fetch(
    `https://www.thesportsdb.com/api/v1/json/3/searchplayers.php?p=${search_input.value}`
  )
    .then((obj) => obj.json())
    .then((obj) => {
      if (obj.player == null) {
...
// Function to add players to the group
let count = 0;
...
// Initial call to fetch and display players
getAllPlayers();
